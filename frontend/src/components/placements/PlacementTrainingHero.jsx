  ...
  return (
    <section className="bg-[#EEF5FF] border-none">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <p className="text-xs sm:text-sm text-gray-500 mb-3 leading-5">
          Home &nbsp;&gt;&nbsp; Placements &nbsp;&gt;&nbsp;
        ...
        <h1
          className="text-3xl sm:text-4xl font-bold text-[#2D2A70]"
        ...
        <p className="mt-3 max-w-2xl text-sm sm:text-base leading-6 sm:leading-7 text-gray-700">
