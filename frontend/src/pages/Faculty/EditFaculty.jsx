...
const EditFaculty = () => {
  ...
  return (
    <>
      ...
      <section className="bg-[#eef3ff] py-6 sm:py-8 lg:py-10 pb-12 sm:pb-16">

        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">

          {/* ================= BREADCRUMB ================= */}

          <div className="text-xs sm:text-sm mb-6 sm:mb-8 flex flex-wrap items-center gap-x-1 gap-y-1">
            ...
            {faculty && (
              <Link
                ...
                className="text-blue-600 hover:underline max-w-[180px] sm:max-w-none truncate"
              >
                {faculty.fullName}
              </Link>
            )}
          ...
          <div className="mb-6 sm:mb-8 flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-6">
            ...
            <input
              type="file"
              className="w-full sm:w-auto max-w-full text-sm"
              onChange={(e) =>
            ...
            <div className="flex gap-5 sm:gap-8 min-w-max">
              ...
              {tabs.map((tab) => (
                ...
                <button
                  ...
                  className={`pb-3 text-sm sm:text-[15px] whitespace-nowrap transition ${
                    activeTab === tab
          ...
          <div className="bg-transparent">
            ...
            {activeTab === "About" && (
              ...
              <textarea
                ...
                className="w-full border border-gray-300 rounded p-3 sm:p-4 outline-none resize-none bg-white text-sm sm:text-base"
              />
              ...
              <div className="space-y-6 sm:space-y-8">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full border border-gray-300 rounded-lg p-3 sm:p-4 bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm sm:text-base"
                  />
              ...
              <div className="space-y-4">
                ...
                {formData.qualifications.map(
                  (item, index) => (
                    ...
                    <div
                      key={index}
                      className="space-y-3 mb-6 bg-white p-4 sm:p-5 rounded-lg border border-gray-200"
                    >
                      ...
                      <input
                        ...
                        className="w-full border border-gray-300 rounded-md px-3 sm:px-4 py-3 bg-white outline-none focus:border-gray-400 text-sm sm:text-base"
                      />
            ...
            {activeTab === "Publications" && (
              ...
              <div className="space-y-4">
                ...
                {formData.structuredPublications.map(
                  (pub, index) => (
            ...
            {activeTab === "Conference Publications" && (
              ...
              <div className="space-y-4">
                ...
                {formData.structuredConferencePublications.map(
                  (item, index) => (
            ...
            {activeTab === "Paper Presentations" && (
              ...
              <div className="space-y-4">
                ...
                {formData.structuredPapersPresented.map(
                  (item, index) => (
            ...
            {activeTab === "Memberships" && (
              ...
              <div className="space-y-4">
                ...
                {formData.structuredMemberships.map(
                  (membership, index) => (
            ...
            <div className="mt-8">
              ...
              <button
                onClick={saveProfile}
                disabled={loading}
                className="w-full sm:w-auto bg-[#4B4B7C] hover:bg-[#3a3a67] text-white px-8 py-3 rounded-lg font-semibold transition"
              >
                {loading
                  ? "Saving..."
                  : "Save Changes"}
