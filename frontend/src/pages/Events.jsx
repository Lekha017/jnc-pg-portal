...
function Events() {
    ...
    const fetchEvents = async () => {
        try {
            ...
            const [upcomingRes, ongoingRes, galleryRes] =
                await Promise.all([
                    getUpcomingEvents(),
                    getOngoingEvents(),
                ...
                <div className="bg-[#1F1A52] text-white py-16">
                    <div className="max-w-7xl mx-auto px-6">
                        ...
                        <p className="mt-4 text-lg text-gray-200 max-w-2xl">
                            Stay updated with upcoming events, seminars,
                            conferences, workshops and explore memorable
                ...
                <div className="max-w-7xl mx-auto px-6 mt-10">
                    <div className="flex flex-wrap gap-4 border-b pb-4">
                        <button
                            ...
                            className={`px-6 py-3 rounded-full font-medium transition ${activeTab === "upcoming"
                        ...
                        <button
                            ...
                            className={`px-6 py-3 rounded-full font-medium transition ${activeTab === "ongoing"
                                ? "bg-[#1F1A52] text-white"
                                : "bg-white border hover:bg-gray-100"
                                }`}
                        >
                        ...
                        <button
                            ...
                            className={`px-6 py-3 rounded-full font-medium transition ${activeTab === "gallery"
                                ? "bg-[#1F1A52] text-white"
                                : "bg-white border hover:bg-gray-100"
                                }`}
                        >
                                        ...
                                        {upcomingEvents.map((event) => (
                                            <EventCard
                                                ...
                                                onImageClick={(images, index) =>
                                                    openModal(images, index, event.title)
                                                }
                                            />
                                        ))}
                                    </div>
                                    ...
                                    <div className="space-y-8">
                                        {galleries.map((gallery) => (
                                            <GalleryCard
                                                ...
                                                gallery={gallery}
                                                onImageClick={(images, index) =>
                                                    openModal(images, index, gallery.title)
                                                }
                                            />
                                        ))}
                                    </div>
